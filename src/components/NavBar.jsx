...
export default function NavBar() {
  return (
    <div className="bg-gray-800 p-4 shadow-xl mx-auto transform rounded-xl">
      <ul className="text-white text-lg flex justify-between list-none cursor-pointer gap-10">
        <NavLink
          to="/"
          className={({ isActive }) =>
            isActive
